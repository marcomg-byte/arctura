...
const Card: FC<CardProps> = ({ adornment = {}, text, title }) => {
  const containerClasses = classNames(
    'au:flex au:flex-col au:gap-3 au:items-start au:self-stretch au:max-w-24 au:min-w-24 au:sm:max-w-28 au:sm:min-w-28 au:md:max-w-36 au:md:min-w-36 au:lg:max-w-44 au:lg:min-w-44 au:rounded-lg au:p-3 au:shadow-md au:transition au:duration-500 au:ease-out au:hover:scale-105 au:hover:shadow-xl'
  );
...
export default function Home() {
  return (
    <Page color="white" title="Home">
      ...
      <div className="au:flex au:items-stretch au:gap-8 au:md:gap-12 au:p-6 au:w-full au:overflow-x-auto">
      ...
      <div className="au:flex au:justify-between au:p-6 au:w-full">
        <div className="au:flex au:flex-col au:gap-3 au:w-1/2">
      ...
      <div className="au:flex au:w-full au:px-6 au:pb-6">
        <div className="au:flex au:bg-primary au:gap-8 au:p-4 au:rounded-lg au:w-full">
      ...
      <div className="au:flex au:justify-between au:items-center au:p-6 au:w-full">
        <div className="au:flex au:flex-col au:gap-3">
          <div className="au:relative au:w-full au:max-w-30 au:aspect-240/170 au:lg:w-30">
            <Image
              src="/images/arctura-footer-logo.png"
              alt="Arctura Logo"
              fill
              sizes="(min-width: 1024px) 240px, 240px"
              className="au:object-contain"
            />
          </div>
          <Typography removePadding clamp={10}>
            A modern UI library for building scalable and consistent digital products.
          </Typography>
        </div>
        <div className="au:flex au:gap-4">
        ...
        <div className="au:flex au:flex-col au:gap-4 au:border-solid au:border-primary au:border-1 au:rounded-lg au:p-3">
          <div className="au:flex au:gap-3">
            <div className="au:w-fit au:bg-subtle au:rounded-lg au:p-1">
          ...
          <Button startAdornment={faStar}>Star on Github</Button>
        </div>
      </div>
    </Page>
  );
