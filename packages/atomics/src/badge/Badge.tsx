 ...
 *
 * @property [children] - Content displayed inside the badge.
 * @property [className] - Additional CSS classes merged into the rendered badge element.
 * @property [color] - Color scheme used for the badge background, border, or text.
 * @property [href] - Optional URL that renders the badge as an anchor link.
 * @property [icon] - Optional FontAwesome icon displayed next to the badge content.
 * @property [iconPosition] - Position of the icon relative to the badge content.
 * @property [ref] - Ref forwarded to the rendered div or anchor element.
 * @property [size] - Size token controlling badge padding and text size.
 * @property [target] - Anchor target used when the badge renders as a link.
 * @property [variant] - Visual treatment for the badge.
 */
 ...
 * @example
 * ```tsx
 * import { Badge } from '@arctura/atomics';
 * import { faCheck } from '@fortawesome/free-solid-svg-icons';
 *
 * export function StatusBadge() {
 *   return (
 *     <Badge color="success" icon={faCheck} iconPosition="start" size="sm" variant="outline">
 *       Active
 *     </Badge>
 *   );
 * }
...
export { Badge };
export type { BadgeColor, BadgeProps, BadgeSize, BadgeVariant, IconPosition as BadgeIconPosition };
