...
/**
 * Class name overrides for the node container and adornment.
 *
 * @property [adornment] - Classes applied to the adornment icon or image.
 ...
 *
 * Use these props when rendering the visual marker for a step, including
 * optional icon/image adornments, color state, size, and circular or extended
 * presentation.
 *
 * @property [children] - Content rendered inside the node.
 * @property [classes] - Class name hooks for the node container and adornments.
 * @property [color] - Color variant applied to border and hover state.
 * @property [endAdornment] - Optional adornment rendered after the children.
 * @property [ref] - Ref forwarded to the root container element.
 * @property [size] - Size token for the node.
 * @property [startAdornment] - Optional adornment rendered before the children.
 ...
 *
 * export function CompletedNodePreview() {
 *   return (
 *     <Node color="success" size="md" variant="circular" endAdornment={faCheck}>
 *       1
 *     </Node>
 *   );
 * }
...
export { Node };
export type { NodeAdornment, NodeClasses, NodeColor, NodeImage, NodeProps };
